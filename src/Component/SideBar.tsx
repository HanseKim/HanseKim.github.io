...
const SideBar:React.FC<SideBarProps> = ({isSidebarVisible, toggleSidebar}) =>{
    return (
        <div className={`transition-transform duration-300 ${isSidebarVisible ? 'translate-x-0' : '-translate-x-full'} bg-white/60 w-[20%] z-40 h-[50%] fixed left-0 top-0 shadow-lg`}>
